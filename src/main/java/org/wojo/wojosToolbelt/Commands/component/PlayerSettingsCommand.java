...
public class PlayerSettingsCommand extends AbstractPlayerCommand {
    private final DefaultArg<boolean> enable;
    private final DefaultArg<Integer> equipPos;
    private final DefaultArg<Integer> targetPos;
    ...
    PlayerSettingsCommand() 
    {
        ...
        this.enable = this.withDefaultArg(
        ...
        this.equipPos = this.withDefaultArg(
        ...
        this.targetPos = this.withDefaultArg(
    ...
    {
        boolean enabled = commandContext.get(PlayerSettingsCommand.enable);
        Integer equipped = commandContext.get(PlayerSettingsCommand.equipPos);
        Integer target = commandContext.get(PlayerSettingsCommand.targetPos);
