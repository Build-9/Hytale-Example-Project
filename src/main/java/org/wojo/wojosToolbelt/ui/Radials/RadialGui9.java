...
public class RadialGui9 extends GenericRadialSelectionUi {

    @Override
    protected void constructFileSpecificData() {
        this._NUM_QA_BUTTONS = 9;
        this._guiFile = QuickAccessConfig.SELECTION_GUI_FILE_NINE;
        this._defaultBgFile = "";
        this._currentBgFile = "";
    ...
    public RadialGui9(@NonNullDecl PlayerRef player_ref, Store<EntityStore> store, ItemStack quick_access_item, Integer quick_access_item_hotbar_position) {
