...
public class ToolSelectionGui extends InteractiveCustomUIPage<ToolSelectionGui.BindingData> {

    public ToolSelectionGui(@Nonnull PlayerRef playerRef, @Nonnull CustomPageLifetime lifetime) {
    ...
    public void build(@Nonnull Ref<EntityStore> ref, @Nonnull UICommandBuilder uiCommandBuilder, @Nonnull UIEventBuilder uiEventBuilder, @Nonnull Store<EntityStore> store) {
        uiCommandBuilder.append("Pages/ToolSelectionGui.ui");
