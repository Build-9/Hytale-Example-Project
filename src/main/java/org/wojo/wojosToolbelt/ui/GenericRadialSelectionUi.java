...
//
public class GenericRadialSelectionUi extends InteractiveCustomUIPage<SelectionUiThreeByThree.SelectionUiData> {
    // ------ Display data ------
    ...
    private ButtonData[] _quickAccessButtons = new ArrayList<ButtonData>();
    ...
    private ButtonData _equipedItemButton =  new ButtonData(null,"","","","false","","#QuickAccessButtonEquipped","#QuickAccessButtonEquippedImg");
    ...
    public GenericRadialSelectionUi(@Nonnull PlayerRef player_ref, Store<EntityStore> store, ItemStack quick_access_item) {
